...
import com.example.taskease.MainScreen
import com.example.taskease.Utils.DatabaseHandler

class ToDoAdapter(private val activity: MainScreen, private val db: DatabaseHandler) : RecyclerView.Adapter<ToDoAdapter.ViewHolder>() {
